<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tube.aspx.cs" Inherits="Tube" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="col-lg-12">
    <asp:GridView ID="gvTube" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false">
         <Columns>
