<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spray.aspx.cs" Inherits="Spray" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="col-lg-12"> 
    <asp:GridView ID="gvSpray" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false">
         <Columns>
