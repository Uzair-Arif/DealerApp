<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Drops.aspx.cs" Inherits="Drops" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="color:white;padding-top:0px;">
                ...
                <a class="navbar-brand" href="main.aspx" style="color:white">DEBIS PHARMA</a>
            </div>
        
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse" style="margin-right:20px">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="default.aspx#products" style="color:white">Products</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="default.aspx#about" style="color:white">About</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="default.aspx#contact" style="color:white">Contact</a>
                    </li>
    ...
    <div class="container-fluid">
        <div class="col-lg-12">
    <asp:GridView ID="gvDrops" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false">
         <Columns>
