<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Capsules.aspx.cs" Inherits="Capsules" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="col-lg-12">
    <asp:GridView ID="gvCapsule" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false">
        <Columns>
