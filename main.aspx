    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#003366">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color:white">DEBEES PHARMA</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <a class="myloginclass" href="Dashboard.aspx" data-toggle="dropdown" style="color:white"> Sign In <strong class="caret"></strong></a>
