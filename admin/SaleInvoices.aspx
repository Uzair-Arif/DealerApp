<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="SaleInvoices.aspx.cs" Inherits="admin_Default" %>
         ...
         <!-- Page Heading -->
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                       ...
                       <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Sale Invoices
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    ...
                    <h2 class="panel-title"> <i class="fa fa-money fa-fw"></i><b>List of Sale Invoice</b></h2>
                            </div>
                        <div class="panel-body">
                    <div class="table-responsive">
                         <asp:UpdatePanel ID="up1" runat="server">
            <ContentTemplate>
                        <asp:GridView ID="gvSaleInvoices" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover table-striped" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvSaleInvoices_PageIndexChanging">
                            <PagerStyle CssClass="bs-pagination"  HorizontalAlign="Center"/>
                            <Columns>
                                <asp:TemplateField HeaderText="ID">
                                   <ItemTemplate>
                                       <asp:Label ID="lblID" runat="server" Text='<%#Eval("sInvoiceID") %>'></asp:Label>
                                   </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Sale Invoice Date">
                                   <ItemTemplate>
                                       <asp:Label ID="lblSaleDate" runat="server" Text='<%# String.Format("{0:M/d/yyyy}",Eval("sInvoiceDate")) %>'></asp:Label>
                                   </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkSaleInvoiceDetail" runat="server" ForeColor="Green" CommandArgument='<%#Eval("SaleID") %>' Text="SaleInvoiceDetials" OnClick="lnkSaleInvoiceDetail_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
            ...
            <Triggers>
            <asp:AsyncPostBackTrigger ControlID="gvSaleInvoices"/>
        </Triggers>
        </asp:UpdatePanel>
                        <br />
                        <%--<asp:ToolkitScriptManager ID="tk1" runat="server"></asp:ToolkitScriptManager>--%>
                        <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="PanelSaleInvoice" TargetControlID="btnCloseInvoice"
    CancelControlID="btnCloseInvoice" BackgroundCssClass="modalBackground" >
</cc1:ModalPopupExtender>
                    <asp:Panel ID="PanelSaleInvoice" runat="server" CssClass="modalPopup"  align="center" style = "display:none">
                      <table>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    Email:dwatson@gmail.com<asp:Label ID="lblemail" runat="server"></asp:Label>
                                </td>
                                <td style="text-align:right">
                                    Payment Status: Paid
                                </td>
               ...
               <asp:TemplateField HeaderText="Net Amount">
                   <ItemTemplate>
                       ...
                       <table>
                        ...
                        <asp:Button  ID="btnExport" runat="server" Text="Export to PDF" CssClass="btn btn-success btn-lg" OnClick="btnExport_Click1"/>
                        </asp:Panel>
