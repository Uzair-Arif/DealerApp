<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="SaleReturnReport.aspx.cs" Inherits="admin_SaleReturnReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <%--<form id="f1" runat="server">--%>
         <div class="row">
                    <div class="col-md-12 col-lg-6">
                       ...
                       <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Sale Retun Report
                            </li>
                        </ol>
                    </div>
                </div>
        <div class="row">
            ...
            <ItemTemplate>
                <a href="JavaScript:divexpandcollapse2('div2<%# Eval("sYear") %>');">
                    <img id='imgdiv2<%# Eval("sYear") %>' width="9px" border="0" 
            ...
            <ItemStyle Width="20px" VerticalAlign="Middle"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Year" HeaderStyle-ForeColor="Black">
                    <ItemTemplate>
                        <asp:Label ID="slblYear" runat="server" Text='<%#Eval("sYear") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField HeaderText="Total Sales" DataField="sTotalSales" HeaderStyle-ForeColor="Black" />
                <asp:BoundField HeaderText="Total Quantity" DataField="sTotalQuantity" HeaderStyle-ForeColor="Black" />
                <asp:BoundField HeaderText="Total Price" DataField="sTotalPrice" HeaderStyle-ForeColor="Black" />
                <asp:TemplateField>
            <ItemTemplate>
            <tr>
            <td colspan="100%">
            <div id='div2<%# Eval("sYear") %>'  style="overflow:auto; display:none;
            ...
            <asp:GridView ID="gvSaleReturnChild" runat="server" Width="95%"
               ...
               <asp:TemplateField ItemStyle-Width="20px">
            <ItemTemplate>
            <a href="JavaScript:divexpandcollapse('div3<%#Eval("sMonth") %>');">
            <img id='imgdiv3<%#Eval("sMonth") %>' width="9px" border="0" src="Images/plus.jpg"
                        alt="" /></a>                       
            </ItemTemplate>
            <ItemStyle Width="20px" VerticalAlign="Middle"></ItemStyle>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Month" HeaderStyle-ForeColor="Black">
                <ItemTemplate>
                    <asp:Label ID="lblMonth" runat="server" Text='<%#String.Format("{0:MMMM}",Eval("sMonth")) %>'></asp:Label>
                    <asp:Label ID="lblmonthnumReturn" runat="server" Text='<%#Eval("sMonth") %>' Visible="false"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:BoundField HeaderText="Total Sales" DataField="sTotalSales"  HeaderStyle-ForeColor="Black"/>
                ...
                <tr>
                    <td colspan="100">
                <div id='div3<%# Eval("sMonth") %>'  style="overflow:auto; display:none;
                                                   position: relative; left: 15px; overflow: auto">
                        ...
                        <Columns>
                        <asp:BoundField DataField="SaleReturnInvoice" HeaderText="Sale Invoice"  HeaderStyle-ForeColor="Black"/>
                                                                                                                     
                        <asp:BoundField DataField="SaleReturnInvoiceDate" HeaderText="Sale Return Invoice Date" HeaderStyle-ForeColor="Black"/>
