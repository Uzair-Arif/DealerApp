<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="NotificationStockEnded.aspx.cs" Inherits="admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <%--<form id="form1" runat="server">--%>
        ...
        <div class="col-lg-11">
        <asp:GridView ID="gvStockEnded" runat="server" AutoGenerateColumns="false" CssClass="table table-hover">
            <Columns>
